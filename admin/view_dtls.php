...
<?php 
	...
	*/
	$query = "SELECT COUNT(*) as num FROM addeuro  where propertyCat='Sell' addeuro ORDER BY Id DESC";
	$total_pages = mysql_fetch_array(mysql_query($query));
	 $total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "view_dtls.php"; 	//your file name  (the name of this file)
	...
	*/
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<a href=\"view_dtls.php?page=$prev\">« previous</a>";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<a href=\"view_dtls.php?page=$counter\">$counter</a>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<a href=\"view_dtls.php?page=$lpm1\">$lpm1</a>";
				$pagination.= "<a href=\"view_dtls.php?page=$lastpage\">$lastpage</a>";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<a href=\"view_dtls.php?page=1\">1</a>";
				$pagination.= "<a href=\"view_dtls.php?page=2\">2</a>";
				$pagination.= "...";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<a href=\"view_dtls.php?page=$next\">next »</a>";
		else
        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td width="50"><img id="layoyt_5" src="images/layoyt_14.gif" width="349" height="41" alt="" /></td>
                          ...
                          <td bgcolor="#F6F6F6"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                              ...
                              <tr>
                                ...
                                <td valign="middle"><table width="100%" border="0">
                                    <tr>
                                      <td width="40%" height="9" id="txtHint"><?=$pagination?></td>
                                      <td colspan="2">&nbsp;</td>
                                      <td width="49%" align="right">
<a href="addview_dtls.php">
                                    ...
                                    <tr>
                                      <td colspan="4" align="left" valign="top"><img src="images/spacer.gif" alt="Spacer" width="1" height="1" />
                                        <table  width="100%" cellspacing="0" cellpadding="0" border="0" >
                                          <tr>
                                            <td width="2%" class="txtb1"></td>
                                            <td width="10%" class="txtb1"> Type</td>
											  <td width="10%" class="txtb1"> Title</td>
											  	  <td width="10%" class="txtb1">Address</td>
                                              <td width="10%" class="txtb1">  Size </td>
                                            <td width="10%" class="txtb1"> Location </td>
                                            <td width="10%" class="txtb1">  Cost </td>
											   <td width="10%" class="txtb1">Bed Room</td>
                                            <td width="10%" class="txtb1">Category</td>
                                            <td width="10%" class="txtb1"> Flat Floor </td>
                                            <td width="2%" class="txtb1">&nbsp;</td>
											 <td width="6%" class="txtb1">&nbsp;</td>
                                          </tr>
                                            ...
                                            <td class="txt-tb1"><?php echo $row['FlatsType'];?> </td>
											 ...
											 <td class="txt-tb1"><?php echo $row['FlatsCost']." ".$row['moneytype'];?></td>
											  <td class="txt-tb1"><?php if($row['bedroom']){echo $row['bedroom']." "."BHK";}?></td>
												...
												<td class="txt-tb1"><img src="images/ico_edit.gif" alt="Edit" border="0" width="15" height="12" /><a href="edit_dtls.php?mode=edit&Id=<?php print $row['id']; ?>">Edit</a></td>
                                            <td class="txt-tb1"><a href="view_dtls.php?mode=DEL&Id=<?php print $row['id']; ?>"><img src="layoyt_butt_white_delete.gif" onClick="return del()" alt="DElET" border="0" width="18" height="22" /></a></td>
                                          </tr>
