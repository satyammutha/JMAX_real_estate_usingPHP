...
echo $t="insert into addeuro set FlatsType='$SocietyFlats', addres='$address',propertytitle='$ptitle',FlatsSize='$FlatsSize',FlatsLocation='$FlatsLocation',
FlatsCost=$FlatsCost,moneytype='$budget',bedroom=$bedroom,FlatsFloor='$FlatsFloor',FlatsImageName='$image_name',propertyCat='$propertyCat',vedio='$uploadvedio'";
                              ...
                              <tr>
                                ...
                                <td valign="middle"><table width="100%" border="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="72%" align="left" valign="top"><b><?=$msg?></b></td>
                                    </tr>
				   ...
				   <option value="DDA Flat" selected="selected">DDA Flat</option>			   
                         ...
                         <option value="0">BedRoom</option>
							...
							<option value="9">9+BHK</option>
                                    ...
                                    <tr>
                                      <td class="txt_add_rec">Vedio Upload Path : </td>
                                      <td><input type="text" name="uploadvedio" id="uploadvedio" size="40" class="txt_input"></td>
                                    </tr>
                                    <tr>
                                      <td class="txt_add_rec">&nbsp;</td>
                                      <td>&nbsp;</td>
