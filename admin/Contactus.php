...
<?php 
	...
	*/
	$query = "SELECT COUNT(*) as num FROM contactus order by dt_tim desc ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	 $total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "Contactus.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM contactus order by dt_tim desc LIMIT $start, $limit";
	...
	*/
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<a href=\"Contactus.php?page=$prev\">« previous</a>";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<a href=\"Contactus.php?page=$counter\">$counter</a>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<a href=\"Contactus.php?page=$lpm1\">$lpm1</a>";
				$pagination.= "<a href=\"Contactus.php?page=$lastpage\">$lastpage</a>";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<a href=\"Contactus.php?page=1\">1</a>";
				$pagination.= "<a href=\"Contactus.php?page=2\">2</a>";
				$pagination.= "...";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<a href=\"Contactus.php?page=$next\">next »</a>";
		else
        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td width="50"><img id="layoyt_5" src="images/layoyt_14.gif" width="351" height="41" alt="" /></td>
                    <td width="715" class="menubar">&nbsp;</td>
                    <td width="203" background="images/layoyt_20.gif" class="menubar2"> ContactUs Details
</td>
                  </tr>
              </table></td>
              <td width="13">&nbsp;</td>
...
<a href="addEuro.php"></a></td>
                                    ...
                                    <tr>
                                      <td colspan="4" align="left" valign="top"><img src="images/spacer.gif" alt="Spacer" width="1" height="1" />
                                        <table  width="100%" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="2%" class="txtb1"><!--<input type="checkbox" name="chkAll" value="checkall" onclick="check(document.frmform.list)"/>--></td>
                                            <td width="15%" class="txtb1">Name</td>
											 <td width="29%" class="txtb1">Email </td>
                                             <td width="14%" class="txtb1">Contact No </td>
                                             <td width="13%" class="txtb1"> Address </td>
                                             <td width="11%" class="txtb1">Description</td>
                                             <td width="8%" class="txtb1"><p>Posted Dated </p></td>
     ...
     <td class="txt-tb1"></td>
                                            <td class="txt-tb1"><?php echo $row[Name];?> </td>
											 <td class="txt-tb1"><?php echo $row[EmailId];?></td>
											 <td class="txt-tb1"><?php echo $row[CellNo];?></td>
											 
											  <td class="txt-tb1"><?php echo $row[Address];?></td>
							<td class="txt-tb1"><?php echo $row[Descraption];?></td>
							
							<td class="txt-tb1"><?php echo $row[dt_tim];?></td>
							<td class="txt-tb1"><a href="Contactus.php?mode=DEL&Id=<?php print $row[ContactId]; ?>"><img src="layoyt_butt_white_delete.gif" alt="DElET" border="0" width="18" height="22" /></a></td>
                                            <td width="1%" class="txt-tb1"></td>
                                          </tr>
