...
<?php 
	...
	*/
	$query = "SELECT COUNT(*) as num FROM feedback order by dt_tim desc ";
	...
	*/
	...
	{	
		...
		//previous button
		if ($page > 1) 
			$pagination.= "<a href=\"feedback.php?page=$prev\">« previous</a>";
		else
		...
		{	
			for ($counter = 1; $counter <= $lastpage; $counter++)
			{
				if ($counter == $page)
					...
					$pagination.= "<a href=\"feedback.php?page=$counter\">$counter</a>";					
			}
		}
		elseif($lastpage > 5 + ($adjacents * 2))	//enough pages to hide some
		{
			...
			if($page < 1 + ($adjacents * 2))		
			{
				...
				$pagination.= "...";
				$pagination.= "<a href=\"feedback.php?page=$lpm1\">$lpm1</a>";
				$pagination.= "<a href=\"feedback.php?page=$lastpage\">$lastpage</a>";		
			}
			//in middle; hide some front and some back
			elseif($lastpage - ($adjacents * 2) > $page && $page > ($adjacents * 2))
			{
				$pagination.= "<a href=\"feedback.php?page=1\">1</a>";
				$pagination.= "<a href=\"feedback.php?page=2\">2</a>";
				$pagination.= "...";
		...
		//next button
		if ($page < $counter - 1) 
			$pagination.= "<a href=\"feedback.php?page=$next\">next »</a>";
		else
        ...
        <td ><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr>
              ...
              <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td width="50"><img id="layoyt_5" src="images/layoyt_14.gif" width="300" height="41" alt="" /></td>
                    <td width="750" class="menubar">&nbsp;</td>
                    <td width="191" background="images/layoyt_20.gif" class="menubar2">
View Feedback
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="23%" height="243" valign="middle"><?php include"menu.php";?></td>
                    <td width="1%">&nbsp;</td>
                                    ...
                                    <tr>
                                      <td colspan="4" align="left" valign="top"><img src="images/spacer.gif" alt="Spacer" width="1" height="1" />
                                        <table  width="100%" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="15%" class="txtb1">S.No</td>
                                            <td width="72%" class="txtb1">Name</td>
                                            <td width="72%" class="txtb1">Address</td>
                                            <td width="72%" class="txtb1">Email Id </td>
                                            <td width="72%" class="txtb1">Contact No </td>
                                            <td width="72%" class="txtb1">Description</td>
											<td width="72%" class="txtb1">Date</td>
										 ...
										 while($row = mysql_fetch_array($result))
	 												...
	 												?> 
                                          <tr>
                                            <td class="txt-tb1"><?php echo $i; ?></td>
											 ...
											 <td class="txt-tb1"><?php echo $row[Address];?></td>
											  <td class="txt-tb1"><?php echo $row[cellNo ];?></td>
											   <td class="txt-tb1"><?php echo $row[EmailId];?></td>
											    <td class="txt-tb1"><?php echo $row[Massage];?></td>
												<td class="txt-tb1"><?php echo $row[dt_tim];?></td>
												
                                            <td class="txt-tb1"><a href="feedback.php?mode=DEL&Id=<?php print $row[feedbackId]; ?>"><img src="layoyt_butt_white_delete.gif" alt="DElET" border="0" width="18" height="22" /></a></td>
                                          </tr>
